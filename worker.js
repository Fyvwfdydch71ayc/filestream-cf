...
const BOT_TOKEN = "7660007316:AAFfKFbH9NbMC3z1g5sZBOCbnxreWXkVglI"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "Ga91"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 6773787379; // Insert your telegram account id.
const BOT_CHANNEL = -1002420871541; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "Gave"; // Insert a powerful secret text and keep it safe.
